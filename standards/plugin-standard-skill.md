...
`skills/` 디렉토리를 스캔하여 사용 가능한 스킬 목록을 수집함.

### Step 2: 안내 출력

사용 가능한 명령 테이블과 자동 라우팅 규칙을 사용자에게 출력함.

## 명령어

| 명령 | 설명 |
|------|------|
| `/my-plugin:help` | 전체 사용 안내 |
| `/my-plugin:help commands` | 명령어 목록만 표시 |
| `/my-plugin:help routing` | 자동 라우팅 규칙만 표시 |
~~~
