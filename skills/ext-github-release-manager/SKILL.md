...
- [ext-github-release-manager](#ext-github-release-manager)
  - [목표](#목표)
  - [선행 요구사항](#선행-요구사항)
  - [활성화 조건](#활성화-조건)
  - [크로스-플러그인 스킬 위임 규칙](#크로스-플러그인-스킬-위임-규칙)
  - [도메인 컨텍스트 수집](#도메인-컨텍스트-수집)
  - [워크플로우](#워크플로우)
    - [Phase 0: 선행 확인](#phase-0-선행-확인)
    - [Phase 1: 도메인 컨텍스트 수집](#phase-1-도메인-컨텍스트-수집)
    - [Phase 2: 경로 분기 결정](#phase-2-경로-분기-결정)
    - [Phase 3: 외부 스킬 위임](#phase-3-외부-스킬-위임)
    - [Phase 4: 결과 검증 및 보고](#phase-4-결과-검증-및-보고)
  - [완료 조건](#완료-조건)
  - [검증 프로토콜](#검증-프로토콜)
  - [상태 정리](#상태-정리)
  - [취소](#취소)
