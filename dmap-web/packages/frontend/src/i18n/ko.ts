...
const ko: Translations = {
  ...
  'plugin.tab.github': 'GitHub에서 추가',
  'plugin.tab.local': '로컬 플러그인 추가',
  'plugin.githubRepo': 'GitHub 저장소',
  'plugin.githubRepoPlaceholder': 'organization/repository',
  'plugin.step.marketplaceAdd': '마켓플레이스 등록 중...',
  'plugin.step.pluginInstall': '플러그인 설치 중...',
  'plugin.error.cliFailure': 'CLI 명령 실행 실패',
  'plugin.error.invalidGithubRepo': '올바른 형식으로 입력해 주세요 (organization/repository)',
  'plugin.error.installInProgress': '다른 플러그인 설치가 진행 중입니다',
  'plugin.warning.registryFailed': '설치는 완료되었지만 목록에 표시되지 않을 수 있습니다. 새로고침하세요.',
  'plugin.workingDirReadonly': '작업경로 (읽기 전용)',
  'plugin.workingDirEdit': '작업경로 변경',
  'plugin.workingDirUpdated': '작업경로가 변경되었습니다',
  'plugin.error.updateFailed': '작업경로 변경 실패',
  'plugin.dirBrowser.newFolder': '새 폴더',
  'plugin.dirBrowser.newFolderPlaceholder': '폴더 이름',
  'plugin.dirBrowser.newFolderError': '폴더 생성 실패',
