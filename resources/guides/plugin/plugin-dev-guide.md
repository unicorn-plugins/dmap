...
## 참고 공유 자원 (선택)
- 참고 가이드: `{DMAP_PLUGIN_DIR}/resources/guides/`에서 활용할 가이드 목록
- 참고 샘플: `{DMAP_PLUGIN_DIR}/resources/samples/`에서 활용할 샘플 목록
- 참고 템플릿: `{DMAP_PLUGIN_DIR}/resources/templates/`에서 활용할 템플릿 목록
- 참고 도구: `{DMAP_PLUGIN_DIR}/resources/tools/`에서 활용할 도구 목록
```
...
완성된 기획서는 `{PLUGIN_DIR}/output/team-plan-{플러그인명}.md`에 저장되며,
...
결과 파일: `{PLUGIN_DIR}/output/team-plan-{플러그인명}.md`
...
리소스 마켓플레이스(`{DMAP_PLUGIN_DIR}/resources/`)에서 선별된 자원을 플러그인 디렉토리로 복사.
...
> 표준 참조: `{DMAP_PLUGIN_DIR}/standards/plugin-standard-agent.md`
...
> 표준 참조: `{DMAP_PLUGIN_DIR}/standards/plugin-standard-skill.md`
...
2. 아래 후보 경로 중 존재하는 첫 번째를 `PLUGIN_BASE_DIR`로 선택
...
## Skill 실행  
`{PLUGIN_DIR}/skills/{skill-name}/SKILL.md 파일을 읽고 실행하세요.
...
| 문서 | 경로 | 참조 시점 |
|------|------|----------|
| DMAP 빌더 표준 | `{DMAP_PLUGIN_DIR}/standards/plugin-standard.md` | 전체 아키텍처, 디렉토리 구조, 배포 |
| Agent 표준 | `{DMAP_PLUGIN_DIR}/standards/plugin-standard-agent.md` | Step 12: 에이전트 개발 |
| Skill 표준 | `{DMAP_PLUGIN_DIR}/standards/plugin-standard-skill.md` | Step 13: 스킬 개발 |
| Gateway 표준 | `{DMAP_PLUGIN_DIR}/standards/plugin-standard-gateway.md` | Step 10: Gateway 설정 |
| 리소스 마켓플레이스 | `{DMAP_PLUGIN_DIR}/resources/plugin-resources.md` | Step 5: 공유 자원 선택, Step 19: 공유자원 등록 |
